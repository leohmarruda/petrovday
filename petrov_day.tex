...
% Title page {{{
% Center Title
\newgeometry{top=0.8in, bottom=0.8in, inner=0.22in, outer=1.38in}
...
\begin{itemize} \itemsep0pt \parskip0pt \parsep0pt
	...
	\item Um candelabro para 9 velas -- não é imprescindível, mas altamente desejável
...
\end{itemize}
Obs: procure realizar em um lugar protegido do vento para que as velas não fiquem se apagando.
