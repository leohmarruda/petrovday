...
ser lido em voz alta. Sempre que houver uma linha horizontal, \'{e} a vez da pr\'{o}
xima pessoa ler, seguindo em sentido hor\'{a}rio. Ao ler cita\c{c}\~{o}es, n\~{a}o \'{e} necess\'{a}rio
...
1.7 milh\~{o}es de anos atr\'{a}s. O cozimento dos alimentos deve ter possibilitado c\'{e}
rebros maiores, que consumiam mais energia, dando caminho \`{a} evolu\c{c}\~{a}o de uma
...
Eles deram nomes às pessoas ao seu redor. Deram nomes a esp\'{e}cies de animais e
plantas. Deram nomes a a\c{c}\~{o}es e lugares e estrat\'{e}gias. Chamaram algumas dessas
...
\blockquote{Em o ano da era de mil trezentos e quarenta e oito anos veio a
...
\page{
% Sneaky quote
\blockquoteUnattributed{Ests inven\c{c}\~{o}es materiais, come\c{c}ando com o uso de pedras
...
ci\^{e}ncia e a tecnologia avan\c{c}aram, o florescimento da humanidade avan\c{c}ou pari
